...
default_ROM = {
    'bicep curl': {
        LEFT: {"left_elbow" : (55, 150), "right_elbow" : (55, 150)},
        RIGHT: {"left_elbow" : (55, 150), "right_elbow" : (55, 150)},
        BOTH: {"left_elbow" : (55, 150), "right_elbow" : (55, 150)},
        EITHER: {"left_elbow" : (55, 150), "right_elbow" : (55, 150)}
    },
    'squat': {
    ...
    'lunge': {
        LEFT: {"left_knee" : (90, 150), "right_knee" : (130, 150)},
        RIGHT: {"left_knee" : (130, 150), "right_knee" : (90, 150)},
        BOTH: {"left_knee" : (90, 150), "right_knee" : (90, 150)},
        EITHER: {"left_knee" : (90, 150), "right_knee" : (90, 150)}
    }
}
